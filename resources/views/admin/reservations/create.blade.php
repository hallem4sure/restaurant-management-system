...
<div class="row">
    <div class="col-lg-8">
        <div class="card card-primary card-outline">
            <div class="card-header"><h3 class="card-title">Reservation Details</h3></div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="datetime-local" name="reserved_at" id="reserved_at"
                                   ...
                                   value="{{ old('reserved_at', now()->format('Y-m-d\TH:i')) }}" required>
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select name="type" id="type" class="form-control @error('type') is-invalid @enderror" required>
                        <option value="scheduled" {{ old('type', 'scheduled') == 'scheduled' ? 'selected' : '' }}>Scheduled Booking</option>
                        <option value="immediate" {{ old('type') == 'immediate' ? 'selected' : '' }}>Immediate (Walk-in)</option>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select name="status" id="status" class="form-control @error('status') is-invalid @enderror" required>
                        ...
                        <option value="seated" {{ old('status') == 'seated' ? 'selected' : '' }}>Seated</option>
                    </select>
